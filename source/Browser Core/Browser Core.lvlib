...
<Library LVVersion="17008000">
	...
	<Item Name="Node Classes" Type="Folder">
		<Item Name="Generic Node.lvclass" Type="LVClass" URL="../Node Classes/Generic Node/Generic Node.lvclass"/>
		<Item Name="UA Node.lvclass" Type="LVClass" URL="../Node Classes/UA Node/UA Node.lvclass"/>
	</Item>
	<Item Name="Server Classes" Type="Folder">
		<Item Name="Base Tree.lvclass" Type="LVClass" URL="../Server Classes/Base Tree/Base Tree.lvclass"/>
		<Item Name="UA Server.lvclass" Type="LVClass" URL="../Server Classes/UA Server/UA Server.lvclass"/>
	</Item>
</Library>
